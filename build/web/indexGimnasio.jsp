<%-- 
    Document   : indexGimnasio
    Created on : 8/08/2017, 07:46:04 PM
    Author     : Leonardo
--%>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <%
                    ...
                    try {
                        Rs = Puente.executeQuery("SELECT * FROM producto WHERE Categoria = 'Gimnasio'");
                ...
                <div class="col-sm-4 col-lg-4 col-md-4" >
                    <form method="POST" action="indexProducto.jsp">
                        <div class="row">
