                    ...
                    <div class="form__field" >
                        ...
                        <div class="col-md-4"  >
                            ...
                            <% 
                                ...
                                rs = puente.executeQuery("Select ciudades.idCiudad , ciudades.Ciudad , cliente.Cedula from ciudades inner join cliente on ciudades.IdCiudad = cliente.Ciudad where cliente.Cedula = '" + BE.getCedula()+ "'");
                                while (rs.next()) {
